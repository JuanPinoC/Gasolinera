<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoBoletas.aspx.cs" Inherits="Bellavista.ListadoBoletas" %>
...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <br />
            <center><h1>Listado de Boletas</h1></center>
            <br />
        </div>
        ...
        <div class="col-sm-12">
            <center>
                <asp:HyperLink ID="hlCrear" runat="server" CssClass="btn btn-lg btn-success" 
                    NavigateUrl="./Boleta.aspx">Crear</asp:HyperLink>
            </center>
            <br />
        </div>
        ...
        <div class="col-sm-8">
            <asp:Table ID="tableList" runat="server" CssClass="table table-hover table-primary">
                <asp:TableHeaderRow>
                    ...
                    <asp:TableHeaderCell>DNI</asp:TableHeaderCell>
